...
typedef struct
{
	...
	IO_Data arc_main;
	IO_Data arc_ptr[GF_ArcMain_Max];
...
static const CharFrame char_gf_frame[] = {
	...
	{GF_ArcMain_Tut0, {  0,   0,  75, 102}, { 39,  71}}, //17 left 1
	{GF_ArcMain_Tut0, { 76,   0,  77, 103}, { 41,  72}}, //18 left 2
	
	{GF_ArcMain_Tut0, {154,   0,  79, 102}, { 37,  71}}, //19 down 1
	{GF_ArcMain_Tut0, {  0, 103,  78, 104}, { 37,  72}}, //20 down 2
	
	{GF_ArcMain_Tut0, { 79, 104,  79, 108}, { 39,  78}}, //21 up 1
	{GF_ArcMain_Tut0, {159, 104,  79, 109}, { 39,  78}}, //22 up 2
	
	{GF_ArcMain_Tut1, {  0,   0,  81, 102}, { 41,  71}}, //23 right 1
	{GF_ArcMain_Tut1, { 81,   0,  76, 103}, { 36,  72}}, //24 right 2
	
	{GF_ArcMain_Tut1, {158,   0,  75, 108}, { 36,  78}}, //25 cheer 1
	{GF_ArcMain_Tut1, {  0, 103,  77, 107}, { 37,  77}}, //26 cheer 2
};
...
Character *Char_GF_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		...
		"tut0.tim", //GF_ArcMain_Tut0
		"tut1.tim", //GF_ArcMain_Tut1
		NULL
	};
